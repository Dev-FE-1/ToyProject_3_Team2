...
|                         홈페이지<br/>검색페이지<br/>구독페이지<br/>동영상 업로드<br/>좋아요/구독 기능                         |                                    공통컴포넌트<br/>로그인페이지<br/>플리메인페이지 구현                                    |                     댓글 페이지<br/>댓글 삭제<br/>구독 페이지<br/>공통 컴포넌트                     |                 홈페이지 퍼블리싱<br/>댓글 작성<br/>무한스크롤<br/>playwright 테스트코드<br/>공통컴포넌트                 |                                    미니영상플레이어<br/>플리메인페이지<br/>마이페이지<br/>플리생성, 라우터<br/>레이아웃<br/>공통컴포넌트                                     |
